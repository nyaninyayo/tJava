...
public class LinkJdbcTemplateRepository implements LinkRepository {
    ...
    public List<Link> findAll() {
        log.info("findAll() method invocation in linkJdbcRepo");
    ...
    public Link findByUrl(String url) {
        log.info("findByUrl() method invocation in linkJdbcRepo");
    ...
    public void add(Link link) {
        log.info("add() method invocation in linkJdbcRepo");
    ...
    public void updateCheckDate(Link link) {
        log.info("updateDate() method invocation in linkJdbcRepo");
    ...
    public void remove(Long id) {
        log.info("remove() method invocation in linkJdbcRepo");
    ...
    public List<Link> findOldLinks(Long timeUpdateDelta) {
        log.info("findOldLinks() method invocation in linkJdbcRepo");
